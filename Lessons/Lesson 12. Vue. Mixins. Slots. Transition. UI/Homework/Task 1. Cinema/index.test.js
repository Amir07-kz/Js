...
describe("h.12.1 Cinema", () => {
    ...
    it("h.12.1.1 Cinema is a Vue instance", () => {
        expect(wrapper.vm).toBeTruthy();
    });

    it("h.12.1.2 Cinema.vue works correct", () => {
        expect(wrapper.element).toMatchSnapshot();
    });

    it("h.12.1.3 CardBlock.vue is correct", () => {
        const cardBlockWrapper = mount(CardBlock.default);
        expect(cardBlockWrapper.element).toMatchSnapshot();
    });

    it("h.12.1.4 DirectorCard.vue is correct", () => {
