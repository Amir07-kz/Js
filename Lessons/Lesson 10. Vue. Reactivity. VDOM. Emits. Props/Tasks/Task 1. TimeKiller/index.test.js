...
describe("c.10.1 TimeKiller", () => {
    ...
    it("c.10.1.5 add more times!", async () => {
        await addButton.trigger("click");
        await addButton.trigger("click");
        await addButton.trigger("click");
        await addButton.trigger("click");
    ...
    it("c.10.1.6 mouseover times", async () => {
    ...
    it("c.10.1.7 add more times! 2", async () => {
        await addButton.trigger("click");
        await addButton.trigger("click");
        await addButton.trigger("click");
        await addButton.trigger("click");
    ...
    it("c.10.1.8 mouseover times 2", async () => {
        const timeElements = wrapper.findAll('.times-container__item');
