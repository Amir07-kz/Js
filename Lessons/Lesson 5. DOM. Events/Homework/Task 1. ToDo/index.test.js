...
describe('h.5.1 toDo', () => {
    ...
    it('h.5.1.1 input and button have been added', () => {
    ...
    it('h.5.1.5 add another task', () => {
        const input = main.querySelector('input');
        input.value = 'посмотреть Интерслеллар';
        ...
        const secondTask = currentTasks[1];
        const secondTaskText = secondTask.textContent;
        expect(secondTaskText).toBe('посмотреть Интерслеллар');
