...
describe("h.9.1 Cards", () => {
        ...
        data() {
            return {
                cards: [
                    {
                        id: 0,
                        src: '/Lessons/Lesson 9. Frameworks 101. Vue.js/Homework/Task 1. Cards/assets/iphone10.jpg',
                    ...
                    {
                        id: 1,
                        src: '/Lessons/Lesson 9. Frameworks 101. Vue.js/Homework/Task 1. Cards/assets/galaxys21.jpg',
                    ...
                    {
                        id: 2,
                        src: '/Lessons/Lesson 9. Frameworks 101. Vue.js/Homework/Task 1. Cards/assets/nokia2600.jpg',
    ...
    it("h.9.1.1 Cards has data", () => {
        expect(typeof Cards.default.data).toBe("function");
    });

    it("h.9.1.2 Cards is a Vue instance", () => {
    ...
    it("h.9.1.3 first card plus button click", async () => {
        const plusButtons = wrapper.findAll('.button-plus');
        const minusButtons = wrapper.findAll('.button-minus');
    ...
    it("h.9.1.4 second card minus button click", async () => {
    ...
    it("h.9.1.5 third card plus button two clicks", async () => {
    ...
    it("h.9.1.6 third card minus button click", async () => {
    ...
    it("h.9.1.7 third card minus button two more clicks", async () => {
        const thirdCardMinusButton = minusButtons.at(2);
