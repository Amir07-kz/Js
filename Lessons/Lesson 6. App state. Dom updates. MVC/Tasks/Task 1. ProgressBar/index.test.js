 ...
 */
const updateProgress = require('./index');

describe('c.6.1 progress', () => {
    ...
    it('c.6.1.3 press increase button six more times', () => {
        for (let i = 0; i < 6; i += 1) {
            increaseButton.click();
        }
        const progressStyle = progressBar.getAttribute('style');
    ...
    it('c.6.1.4 press decrease button two times', () => {
    ...
    it('c.6.1.5 press decrease button twenty more times', () => {
