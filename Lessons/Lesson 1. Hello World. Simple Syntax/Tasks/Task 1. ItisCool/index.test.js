...
const itisCool = require('./index');

describe('c.1.1 itisCool', () => {
    const itis = 'Itis';
    const cool = 'Cool';
    ...
    it('c.1.1.4 one element', () => {
        itisCool(45, 45);

        expect(spy.withArgs('ItisCool').calledOnce).toBe(true);
    });

    it('c.1.1.5 console.log not called', () => {
        itisCool(35, 25);
